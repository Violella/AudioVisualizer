...
public class Constants {
    ...
    // Video
    public static final String VIDEO_DEFAULT_SOURCE         = PATH_VIDEO_RESOURCES + "big_buck_bunny.mp4";
    public static final String VIDEO_DEFAULT_DESTINATION    = PATH_VIDEO_RESOURCES + "big_buck_bunny_m1.mp4";
